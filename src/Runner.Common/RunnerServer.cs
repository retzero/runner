...
namespace GitHub.Runner.Common
{
    ...
    public interface IRunnerServer : IRunnerService
    {
        ...
        Task DeleteAgentAsync(int agentPoolId, long agentId);
        Task DeleteAgentAsync(long agentId);
        ...
        // agent update
        Task<TaskAgent> UpdateAgentUpdateStateAsync(int agentPoolId, long agentId, string currentState, string trace);
    }
    ...
    public sealed class RunnerServer : RunnerService, IRunnerServer
    {
        ...
        public Task DeleteAgentAsync(int agentPoolId, long agentId)
        {
            CheckConnection(RunnerConnectionType.Generic);
            return _genericTaskAgentClient.DeleteAgentAsync(agentPoolId, agentId);
        }

        public Task DeleteAgentAsync(long agentId)
        {
        ...
        public Task<TaskAgent> UpdateAgentUpdateStateAsync(int agentPoolId, long agentId, string currentState, string trace)
        {
            CheckConnection(RunnerConnectionType.Generic);
